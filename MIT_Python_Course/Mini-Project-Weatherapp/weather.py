...
class Weather:
    ...
    def post_data(self):
        ...
        print(f"The temparature in {self.name} is {self.temp}°C")
        print(f"The minimum temparature in {self.name} is {self.temp_min}°C")
        print(f"The maximum temparature in {self.name} is {self.temp_max}°C")
